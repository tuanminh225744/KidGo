...
export const DropoffPhotoModal = ({ fileInputRef, handlePhotoChange, photoInput, submitPhoto, errorMsg, loading }) => (
  <motion.div
    ...
    <h3 className="text-2xl font-black text-primary mb-2">Chụp ảnh trả bé</h3>
    <p className="text-gray-500 text-sm mb-6">Xin hãy chụp 1 bức ảnh với người nhận bé để phụ huynh yên tâm.</p>
