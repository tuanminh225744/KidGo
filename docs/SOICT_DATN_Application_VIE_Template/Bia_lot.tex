...
\begin{titlepage}
  ...
  \begin{center}
    ...
    {\textbf{\Large{Thiết kế xây dựng hệ thống đặt xe dành cho trẻ em KidGo}}\\[1cm]

      {\textbf{\large{PHẠM TUẤN MINH}}}\\
      {\large{minhpt225744@sis.hust.edu.vn}}\\[0.5cm]
      ...
      \begin{table}[H]
        ...
        \resizebox{\textwidth}{!}{%
          \begin{tabular}{ll}
            \multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & ThS. Nguyễn Duy Hiệp \hspace{0.5cm} \underline{\hspace{3cm}} \\[0.5cm]
